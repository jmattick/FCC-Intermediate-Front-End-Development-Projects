...
//Geting location and weather information 
...
$.getJSON(getIP).done(function(location) {
    $.getJSON(openWeatherMap, {
        ...
        //conditional statement to match gifs to weather. For future applications, a better source of gifs should be used. 
          if (tempC < -10) {
  ...
  //the sassy comment responses can be added in or altered at a future date if desired.   
});
